...
import 'package:example/modules/home/models/home_response_model.dart';

abstract class HomeRepo {
  Future<HomeResponseModel?> getAll({required String page, required String itemPerPage});
...
class HomeRepoImpl implements HomeRepo {
  ...
  @override
  Future<HomeResponseModel?> getAll({required String page, required String itemPerPage}) async {
    try {
      final response = await service.getAll(page: int.parse(page), limit: int.parse(itemPerPage));
      if (response != null) {
        return await IsolateHandler.run<dynamic, HomeResponseModel>(response, (json) => HomeResponseModel.fromJson(json));
      }
      return null;
    } catch (e, st) {
