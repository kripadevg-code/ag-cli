...
class ProductsDetailsAppBar extends StatelessWidget implements PreferredSizeWidget {
  const ProductsDetailsAppBar({super.key, required this.controller});
...
class _NormalBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AppBar(
    title: Text(title ?? 'ProductsDetails'),
    actions: [
